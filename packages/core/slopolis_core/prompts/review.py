...
def compose_system_prompt() -> str:
    ...
    return (
        ...
        "- suggestion: the literal replacement for the cited line(s) — the exact "
        "code to put in their place, in the file's own language, and nothing "
        "else. Only the lines being replaced; no prose, no explanation, no "
        "markdown fence. Use null when the fix cannot be written as replacement "
        "code, and put that advice in message instead.\n"
